 ...
 * and creates an object for the Southwest Airline flight
 *
            ...
            while (true) {
                ...
                if (found && s.equals("")) {
                    ...
                    if (other) {
                        ...
                        addPassenger(new Passenger("Southwest", info[0], lastName, Integer.parseInt(info[2])));
                    }
                    other = !other;
                } else if (s.equals("Southwest passenger list")) {
                    found = true;
                }
            }
            bfr.close();
